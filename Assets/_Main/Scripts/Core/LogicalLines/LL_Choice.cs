...
namespace Dialogue.LogicalLines
{
    public class LL_Choice : ILogicalLine
    {
        ...
        public IEnumerator Execute(DialogueLine line)
        {
            ...
            if (panel == null)
            {
                Debug.LogError("ChoicePanel instance not found.");
                yield break;
            }
        ...
        private RawChoiceData RipChoiceData()
        {
            ...
            RawChoiceData data = new RawChoiceData
            {
        ...
        private bool IsEncapsulationStart(string line) => line.Trim().StartsWith(ENCAPSULATION_START.ToString());
        private bool IsEncapsulationEnd(string line) => line.Trim().StartsWith(ENCAPSULATION_END.ToString());
