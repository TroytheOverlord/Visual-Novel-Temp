...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Characters : CMD_Database_Extension
    {
        ...
        private static IEnumerator MoveCharacter(string[] data)
        {
            ...
            //try to get the imediate position
            ...
            {
                CommandsManager.instance.AddTerminateActionToCurrentProcess(() => {character?.SetPosition(position); });
        ...
        public static IEnumerator ShowAll(string[] data)
        {
            ...
            if(!immediate)
            {
                ...
                CommandsManager.instance.AddTerminateActionToCurrentProcess(() =>
                {
                    foreach(Character character in characters)
                        character.Show();
                });
                // End of Potential Error Line
