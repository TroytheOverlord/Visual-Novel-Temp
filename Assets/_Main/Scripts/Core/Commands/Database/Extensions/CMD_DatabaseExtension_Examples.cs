...
namespace COMMANDS
{
    ...
    public class CMD_DatabaseExtension_Examples : CMD_Database_Extension
    {
        new public static void Extend(CommandDatabase database){
            //Add Actioncommand with no parameters
        ...
        private static IEnumerator MoveCharacter(string direction){
            ...
            // Calculates the target position for the image 
            float targetX = left ? -8 : 8;

            // Calculates the current position of the image 
