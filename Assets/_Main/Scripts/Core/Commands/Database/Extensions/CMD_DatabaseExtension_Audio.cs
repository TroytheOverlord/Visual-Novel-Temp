...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Audio : CMD_Database_Extension
    {
        ...
        private static string[] PARAM_CHANNEL = new string[] { "-c", "-chanel"};
        ...
        private static void PlayVoice(string[] data)
        {
            ...
            if(sound == null)
            {
                Debug.Log($"Was unable to load voice '{filepath}'");
                return;
            }
