...
namespace COMMANDS
{
    public class CommandParameters 
    {
        ...
        {
            if (typeof(T) == typeof(bool) && bool.TryParse(parameterValue, out bool boolValue))
            {
                value = (T)(object)boolValue;
                return true;
            }

            if (typeof(T) == typeof(int) && int.TryParse(parameterValue, out int intValue))
            {
                value = (T)(object)intValue;
                return true;
            }

            if (typeof(T) == typeof(float) && float.TryParse(parameterValue, out float floatValue))
            {
