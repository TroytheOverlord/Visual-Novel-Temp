...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        //public Color unhighlightedColor => new Color(color.r * UNHIGHLIGHTED_DARKEN_STRENGTH, color.g * UNHIGHLIGHTED_DARKEN_STRENGTH, color.b * UNHIGHLIGHTED_DARKEN_STRENGTH, color.a);
        //public bool highlighted { get; protetcted set; } = true;
        ...
        public void SetDialogue(TMP_FontAsset font) => config.dialogueFont = font;
