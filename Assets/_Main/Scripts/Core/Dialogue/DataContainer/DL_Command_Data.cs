...
/*
    Data container for commands and arguments that'll be executed in a dialogue line 
*/
...
namespace Dialogue{
    ...
    public class DL_Command_Data
    {
        ...
        private const char ARGUEMENTSCONATINER_ID = '(';
        ...
        public List<Command> RipCommands(string rawCommands){
            ...
            foreach(string cmd in data){
                ...
                int index = cmd.IndexOf(ARGUEMENTSCONATINER_ID);
