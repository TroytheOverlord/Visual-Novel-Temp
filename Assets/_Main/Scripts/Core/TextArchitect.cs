...
public class TextArchitect
{
    ...
    // If ui space is avaliable in the text mesh then we use the ui 
    // space text else we use the world space text
    public TMP_Text tmpro => tmpro_ui != null ? tmpro_ui : tmpro_world;

    public string currentText => tmpro.text;
    // The information in the curly braces means targetText can be received publicly 
    // but can only be assigned privately
    public string targetText {get; private set;} = "";

    // Allows new text to be appended to current text
    ...
    // Appends text to existing line of text
    ...
    // Check if text is currently being built 
    public Coroutine buildProcess = null;
    public bool isBuilding => buildProcess != null;

    // If text is being built stops it
    public void Stop(){
        if(!isBuilding)
            return;
    ...
    private void Prepare_Instant(){
        ...
        // Forces any changes made to the Text Mesh
        tmpro.ForceMeshUpdate();
        tmpro.maxVisibleCharacters = tmpro.textInfo.characterCount;
    }
